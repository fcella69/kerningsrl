      ...
      <div className={styles.inner}>
        <div ref={contentRef} className={styles.content}>
          ...
          <div className={styles.metaRow}>
            <span className={styles.metaChip}>Strategia visiva</span>
            <span className={styles.metaChip}>Struttura chiara</span>
            <span className={styles.metaChip}>Esperienza su misura</span>
          </div>
        </div>
        ...
        <div ref={visualRef} className={styles.visual}>
          {image?.asset?.url ? (
            <div className={styles.visualArt}>
              <Image
                src={image.asset.url}
                alt={image.alt || "Web design project visual"}
                fill
