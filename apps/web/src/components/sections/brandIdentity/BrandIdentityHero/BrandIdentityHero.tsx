...
import styles from "./BrandIdentityHero.module.css";
      ...
      <div className={styles.inner}>
        <div ref={contentRef} className={styles.content}>
          ...
          <div className={styles.metaRow}>
            <span className={styles.metaChip}>Logo system</span>
            <span className={styles.metaChip}>Visual direction</span>
            <span className={styles.metaChip}>Applicazioni coerenti</span>
          </div>
        </div>
        ...
        <div ref={visualRef} className={styles.visual}>
          {image?.asset?.url ? (
            <div className={styles.visualArt}>
              <Image
                src={image.asset.url}
                alt={image.alt || "Brand identity project visual"}
                fill
                ...
                <div className={styles.mockup}>
                  ...
                  <div className={styles.mockupBody}>
                    ...
                    <div className={styles.mockupColumns}>
                      <div className={styles.mockupColumnTall} />
                      <div className={styles.mockupColumnStack}>
                        <div />
                        <div />
                        <div />
                      </div>
